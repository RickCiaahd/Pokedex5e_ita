...
Il workflow `Android release` può essere avviato manualmente dopo la configurazione dei secret. Un tag `v*`, per esempio `v1.0.1`, genera anche una GitHub Release con APK, AAB e checksum SHA-256.

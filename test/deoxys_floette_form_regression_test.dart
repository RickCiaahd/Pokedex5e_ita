...
void main() {
  ...
  test('Floette flower forms resolve distinct normal and shiny sprites', () async {
    final catalog = await PokemonRepository().getAllPokemon();
    final floette = catalog.firstWhere((pokemon) => pokemon.id == 670);
    const forms = ['Yellow Flower', 'Orange Flower', 'Blue Flower', 'White Flower'];
  ...
  testWidgets('Floette flower sprites are included in the Flutter asset bundle', (
    tester,
  ) async {
